...
namespace Operators__William_Garcia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            $"The min of the two {Math.Min(intMult,intAdd)}");
            ...
            $"The min of the two {Math.Min(floatMult, floatAdd)}");
